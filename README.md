...
Sampo supports multiple processing modes:
...
2. **Clone Locally**: Clone the forked repository to your local machine using a git client.
   ```sh
   git clone https://github.com/mamorett/Sampo
   ```
...
<br>
<p align="left">
   <a href="https://github.com/mamorett/Sampo/graphs/contributors">
      <img src="https://contrib.rocks/image?repo=mamorett/Sampo">
   </a>
</p>
</details>
